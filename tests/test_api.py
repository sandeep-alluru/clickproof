...
class TestAddObservation:
    ...
    def test_observe_nonexistent_fact_returns_404(self, client: TestClient, db_path: str) -> None:
        r = client.post(
            "/observe",
            json={
                "fact_id": "nonexistent",
...
class TestQuery:
    ...
    def test_query_response_has_fact_and_score(self, client: TestClient, db_path: str) -> None:
        client.post(
            "/fact",
            json={
                "app_name": "app",
