...
- MCP server (`guiproof-mcp`) with `add_ui_fact`, `query_facts`, `bootstrap_context` tools
- 109 unit tests across all layers with 87%+ branch coverage

[Unreleased]: https://github.com/sandeep-alluru/guiproof/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/sandeep-alluru/guiproof/releases/tag/v0.1.0
